# This file was generated by Foo::Mousse::Maker 0.10 from Mouse 0.80.
#
...
sub _unite { # overload infix:<|>
	my($lhs, $rhs) = @_;
	require Foo::Mousse::Util::TypeConstraints;
	return Foo::Mousse::Util::TypeConstraints::find_or_parse_type_constraint(
	   " $lhs | $rhs",
	);
}
...
sub _metaclass_cache { # DEPRECATED
	my($self, $name) = @_;
	Carp::cluck('_metaclass_cache() has been deprecated. Use Foo::Mousse::Util::get_metaclass_by_name() instead');
	return $METAS{$name};
}
...
sub _collect_methods { # Foo::Mousse specific
	my($meta, @args) = @_;
